...
def migrate():
    ...
    # This script rewrites tables with raw sqlite3 and only applies to SQLite.
    # On Supabase/PostgreSQL run instead:
    #   ALTER TABLE products      ALTER COLUMN category_id DROP NOT NULL;
    #   ALTER TABLE subcategories ALTER COLUMN category_id DROP NOT NULL;
    if not settings.DATABASE_URL.startswith('sqlite'):
        print("This migration is SQLite-only. For PostgreSQL/Supabase run:")
        print("  ALTER TABLE products      ALTER COLUMN category_id DROP NOT NULL;")
        print("  ALTER TABLE subcategories ALTER COLUMN category_id DROP NOT NULL;")
        return False
