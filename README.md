> **Deployment:** this copy is configured for **Supabase (PostgreSQL) + Railway**.
> See **[DEPLOY.md](DEPLOY.md)** for step-by-step setup, and **[AUDIT.md](AUDIT.md)**
> for the list of bugs fixed in this version.
>
> Entrypoint is `app.py` (bot + CryptoBot webhook in one process).
> `python bot.py` still runs the bot alone.
